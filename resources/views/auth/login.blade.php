            ...
            <div class="w-full lg:w-1/2 p-8 mt-12">
                ...
                <form action="{{ url('/login') }}" method="post" id="loginForm">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" name="email" value="{{ old('email') }}" placeholder="Email">
                    </div>
                    <div class="mb-4 relative">
                        <label class="block text-gray-700 font-bold mb-2"><strong>Palavra passe</strong></label>
                        <div class="relative">
                            <input type="password" id="password" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 pr-10" name="password" placeholder="Palavra passe">
